...
alias localjjs="java -XX:+UnlockExperimentalVMOptions -XX:+EnableJVMCI -XX:+UseJVMCICompiler --module-path=$JJS_JARSPATH/graal-sdk-21.0.0.2.jar:$JJS_JARSPATH/truffle-api-21.0.0.2.jar --upgrade-module-path=$JJS_JARSPATH/compiler-21.0.0.2.jar:$JJS_JARSPATH/compiler-management-21.0.0.2.jar -cp $JJS_JARSPATH/launcher-common-21.0.0.2.jar:$JJS_JARSPATH/js-launcher-21.0.0.2.jar:$JJS_JARSPATH/js-21.0.0.2.jar:$JJS_JARSPATH/truffle-api-21.0.0.2.jar:$JJS_JARSPATH/graal-sdk-21.0.0.2.jar:$JJS_JARSPATH/js-scriptengine-21.0.0.2.jar:$JJS_JARSPATH/regex-21.0.0.2.jar:$JJS_JARSPATH/icu4j-68.2.jar:$JJS_JARSPATH/postgresql-42.2.18.jar  com.oracle.truffle.js.shell.JSLauncher"
alias runpg="docker run -d --rm -it -v $PWD/postgresql:/docker-entrypoint-initdb.d -e  POSTGRES_USER=pguser -e POSTGRES_DB=pgdb  -e POSTGRES_PASSWORD=pgpassword  -p 5432:5432 postgres:12-alpine"
